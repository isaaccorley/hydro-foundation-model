...
class SwinTransformerV2(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.sizes = [
            self.patches_resolution[0] // (2**i) for i in range(self.num_layers)
        ]
        self.sizes.append(self.sizes[-1])
        self.reductions = [self.img_size // size for size in self.sizes][
            : self.num_layers + 1
        ]
    ...
    def get_intermediate_layers(
        ...
        if reshape:
            features = [
                feat.reshape(b, h // r, w // r, -1).permute(0, 3, 1, 2).contiguous()
